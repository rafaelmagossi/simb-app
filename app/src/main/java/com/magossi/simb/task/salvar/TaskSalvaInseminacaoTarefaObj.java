 ...
 */
public class TaskSalvaInseminacaoTarefaObj extends AsyncTask<Tarefa, String, String> {
    ...
    private InseminacaoTarefaObjInterface inseminacaoTarefaObjInterface;
    private ProgressDialog progress;


    public TaskSalvaInseminacaoTarefaObj(Context context, InseminacaoTarefaObjInterface inseminacaoTarefaObjInterface){
        this.context = context;
        this.inseminacaoTarefaObjInterface = inseminacaoTarefaObjInterface;
    }
    ...
    protected String doInBackground(Tarefa... params) {
        int id = params[0].getBovinoMatriz().getFichaMatriz().getInseminacao().size()-1;
        String urlTarefa = null;
        ...
        try{
            ...
            String url = URL.replace("{id}", params[0].getIdTarefa().toString());
            RestTemplate restTemplate = new RestTemplate();
            restTemplate.getMessageConverters().add(new MappingJackson2HttpMessageConverter());
            //urlBovino = restTemplate.postForObject(URL,params[0],String.class);
            urlBovino = restTemplate.postForLocation(url,params[0].getBovinoMatriz()
                    .getFichaMatriz().getInseminacao().get(id),String.class).toString();
    ...
    protected void onPostExecute(String params) {
        ...
        if(params != null ){
            inseminacaoTarefaObjInterface.depoisAlteraInseminacaoTarefa(params, null);
            progress.dismiss();
            ...
            inseminacaoTarefaObjInterface.depoisAlteraInseminacaoTarefa(null, erroHttp.getStatusCode().toString());
            progress.dismiss();
            Toast.makeText(this.context, "Erro ao Salvar", Toast.LENGTH_SHORT).show();
        }
    }
